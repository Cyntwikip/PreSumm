...
## Training
python train.py -task abs -mode train -bert_data_path "../bert_data/$TRAIN_FOLDER/" -dec_dropout 0.2  -model_path "$FINETUNED_MODEL_PATH" -sep_optim true -lr_bert 0.002 -lr_dec 0.2 -save_checkpoint_steps 100 -batch_size 16 -train_steps 148100 -report_every 20 -accum_count 5 -use_bert_emb true -use_interval true -warmup_steps_bert 100 -warmup_steps_dec 50 -max_pos 512 -visible_gpus 0 -log_file "../logs/$LOG_NAME"  -train_from ../models/bertextabs.pt
